...
module.exports = class Blockchain {
  ...
  getBlock(blockHeight) {
    return db.get(blockHeight)
      ...
      .catch((err) => {
        console.log(`Can't find block of height ${blockHeight}, err: ${err}`);
        return `Can't find block of height ${blockHeight}, err: ${err}`;
    })
  }
    ...
    if (!arguments.length) {
      ...
      return db.get("blockHeight")
        .then((height) => {
          ...
          return this.validateChain(db.get(obj.i), obj);
        })
      ...
      return promise
        .then(value => {
          ...
          if (obj.i < obj.height) {
            ...
            if (obj.errLog.length < 1) {
              console.log(`Blockchain was successfully validated`);
